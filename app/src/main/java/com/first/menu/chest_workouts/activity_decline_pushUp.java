...
public class activity_decline_pushUp extends AppCompatActivity {

    ImageView btnTutorial, lefticon;

    Button btnDone,btnSkip;

    TextView timer, NextExercise, youtubeIndicator,demoIndicator;

    MediaPlayer mediaPlayer, mediaPlayer2, declinepushup_done;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_decline_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new activity_decline_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.chest_declinepushup);
        mediaPlayer2.start();

        /*Link for tutorial
        btnTutorial = findViewById(R.id.declinepushup_link);
        ...
        timer = findViewById(R.id.timer_declinepushup);
        btnDone = findViewById(R.id.declinepushup_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_hindu);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                declinepushup_done = MediaPlayer.create(activity_decline_pushUp.this, R.raw.chest_declinepushupdone);
                declinepushup_done.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Hindu Push-Up");
                StyleableToast.makeText(activity_decline_pushUp.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(declinepushup_done != null) {
                            declinepushup_done.stop();
                            declinepushup_done.release();
                            declinepushup_done = null;
                        }
                        startActivity(new Intent(activity_decline_pushUp.this, activity_hindu_pushUp.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Chest/Decline Push Ups").setValue(formattedCalorieBurn);

                                        // Save the calorie burn value in the Chest_Record object
                                        Chest_Record chestRecord = new Chest_Record();
                                        chestRecord.setDeclineCB(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_decline_pushUp.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_decline_pushUp.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                        */
                    }
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_decline_pushUp.this, MainActivity.class));

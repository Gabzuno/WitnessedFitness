...
public class activity_wideArm_pushUp extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer, mediaPlayer2, widearmpushup_done;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_wide_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_widearm_pushup);
        ...
        adapter = new activity_wide_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.chest_widearmpushup);
        mediaPlayer2.start();

        /*Link for tutorial
        btnTutorial = findViewById(R.id.wideArmPushUp_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=pQUsUHvyoI0");
            }
        });
        ...
        timer = findViewById(R.id.timer_widearmpushup);
        btnDone = findViewById(R.id.widearmpushup_btndone);
        NextExercise = findViewById(R.id.nextexercise_clap);
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                widearmpushup_done = MediaPlayer.create(activity_wideArm_pushUp.this, R.raw.chest_widearmpushupdone);
                widearmpushup_done.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Clap Push-Up");
                StyleableToast.makeText(activity_wideArm_pushUp.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(widearmpushup_done != null) {
                            widearmpushup_done.stop();
                            widearmpushup_done.release();
                            widearmpushup_done = null;
                        }
                        startActivity(new Intent(activity_wideArm_pushUp.this, activity_clap_pushUp.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Chest/Wide Arm Push Ups").setValue(formattedCalorieBurn);

                                        // Save the calorie burn value in the Chest_Record object
                                        Chest_Record chestRecord = new Chest_Record();
                                        chestRecord.setWideArmCB(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_wideArm_pushUp.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_wideArm_pushUp.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                        */
                    }
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_wideArm_pushUp.this, MainActivity.class));

...
public class activity_knee_pushUp extends AppCompatActivity {

    Button btnDone, btnSkip;

    TextView timer, NextExercise,youtubeIndicator,demoIndicator;

    MediaPlayer mediaPlayer, mediaPlayer2, kneepushup_done;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_knee_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knee_pushup);
        ...
        adapter = new activity_knee_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.chest_kneepushup);
        mediaPlayer2.start();

        /*Link for tutorial
        btnTutorial = findViewById(R.id.kneepushup_link);
        ...
        timer = findViewById(R.id.timer_kneepushup);
        btnDone = findViewById(R.id.kneepushup_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_diamond);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                kneepushup_done = MediaPlayer.create(activity_knee_pushUp.this, R.raw.chest_kneepushupdone);
                kneepushup_done.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Diamond Push-Up");
                StyleableToast.makeText(activity_knee_pushUp.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(kneepushup_done != null) {
                            kneepushup_done.stop();
                            kneepushup_done.release();
                            kneepushup_done = null;
                        }
                        startActivity(new Intent(activity_knee_pushUp.this, activity_diamond_pushUp.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        String recordKey = reference.child(Uid).child("Calorie Burn/Chest/Knee Push Up").push().getKey();
                                        // Store the calorie burn in the database under the generated record key
                                        reference.child(Uid).child("Calorie Burn/Chest/" + recordKey + "/Knee Push Up").setValue(formattedCalorieBurn);
                                        ...
                                        chestRecord.setKneeCB(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_knee_pushUp.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_knee_pushUp.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                        */
                    }
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_knee_pushUp.this, MainActivity.class));
    ...
    private void gotoUrl() {
        Uri uri = Uri.parse("https://www.youtube.com/watch?v=jWxvty2KROs");

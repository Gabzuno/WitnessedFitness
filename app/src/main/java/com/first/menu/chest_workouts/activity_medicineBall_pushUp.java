...
public class activity_medicineBall_pushUp extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer, mediaPlayer2, medicineballpushup_done;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_medicine_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicineball_pushup);
        ...
        adapter = new activity_medicine_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.chest_medicineballpushup);
        mediaPlayer2.start();

        /*Link for tutorial
        btnTutorial = findViewById(R.id.medicineBallPushUp_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=Lqdka8XUG50");
            }
        });
        ...
        timer = findViewById(R.id.timer_medicineballpushup);
        btnDone = findViewById(R.id.medicineballpushup_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_burpees);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                medicineballpushup_done = MediaPlayer.create(activity_medicineBall_pushUp.this, R.raw.chest_medicineballpushupdone);
                medicineballpushup_done.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Burpees");
                StyleableToast.makeText(activity_medicineBall_pushUp.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(medicineballpushup_done != null) {
                            medicineballpushup_done.stop();
                            medicineballpushup_done.release();
                            medicineballpushup_done = null;
                        }
                        startActivity(new Intent(activity_medicineBall_pushUp.this, activity_burpees.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Chest/Medicine Ball Push Ups").setValue(formattedCalorieBurn);

                                        // Save the calorie burn value in the Chest_Record object
                                        Chest_Record chestRecord = new Chest_Record();
                                        chestRecord.setMedicineCB(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_medicineBall_pushUp.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_medicineBall_pushUp.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                        */
                    }
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_medicineBall_pushUp.this, MainActivity.class));

...
public class activity_sidearm_raise extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer, mediaPlayer2,sidearmDone;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_sidearm_raise_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sidearm_raise);
        ...
        adapter = new activity_sidearm_raise_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.arm_sidearm);
        mediaPlayer2.start();

        /*Link for tutorial
        btnTutorial = findViewById(R.id.sidearmraise_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=YslHgg2E-Ro");
            }
        });

         */

        timer = findViewById(R.id.timer_sidearmraise);
        btnDone = findViewById(R.id.sidearmraise_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_armcircle);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sidearmDone = MediaPlayer.create(getApplicationContext(), R.raw.arm_done_sidearm);
                sidearmDone.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Arm Circle");
                StyleableToast.makeText(activity_sidearm_raise.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_sidearm_raise.this, activity_arm_circle.class));
                    ...
                    public void onFinish() {
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Arm/Side Arm Raise").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_sidearm_raise.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_sidearm_raise.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                        */
                    }
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_sidearm_raise.this, MainActivity.class));

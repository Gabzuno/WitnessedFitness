...
public class activity_sidePlank_rotation extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer, mediaPlayer2, sidePlankDone;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_sidePlank_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sideplank_rotation);
        ...
        adapter = new activity_sidePlank_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.arm_sideplankrotation);
        mediaPlayer2.start();
        /*Link for tutorial
        btnTutorial = findViewById(R.id.sidePlankRotation_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=DXQ9YKHtcsk");
            }
        });

         */

        timer = findViewById(R.id.timer_sideplankrotation);
        btnDone = findViewById(R.id.sideplankrotation_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_superman);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sidePlankDone = MediaPlayer.create(activity_sidePlank_rotation.this, R.raw.arm_done_sideplankrotation);
                sidePlankDone.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Superman With Arm Extension");
                StyleableToast.makeText(activity_sidePlank_rotation.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (sidePlankDone != null) {
                            sidePlankDone.stop();
                            sidePlankDone.release();
                            sidePlankDone = null;
                        }

                        startActivity(new Intent(activity_sidePlank_rotation.this, activity_superman.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Arm/Side Plank Rotation").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_sidePlank_rotation.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_sidePlank_rotation.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_sidePlank_rotation.this, MainActivity.class));

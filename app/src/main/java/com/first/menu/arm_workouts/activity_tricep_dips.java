...
public class activity_tricep_dips extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer, mediaPlayer2, tricepsDipDone;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_triceps_dips_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new activity_triceps_dips_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.arm_tricepdips);
        mediaPlayer2.start();

        /*Link for tutorial
        btnTutorial = findViewById(R.id.tricepdips_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=JhX1nBnirNw");
            }
        });

         */

        timer = findViewById(R.id.timer_tricepdips);
        btnDone = findViewById(R.id.tricepdips_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_sideplankrotation);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tricepsDipDone = MediaPlayer.create(activity_tricep_dips.this, R.raw.arm_done_tricepdips);
                tricepsDipDone.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Side Plank Rotation");
                StyleableToast.makeText(activity_tricep_dips.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (tricepsDipDone != null) {
                            tricepsDipDone.stop();
                            tricepsDipDone.release();
                            tricepsDipDone = null;
                        }

                        startActivity(new Intent(activity_tricep_dips.this, activity_sidePlank_rotation.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Arm/Triceps Dip").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_tricep_dips.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_tricep_dips.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_tricep_dips.this, MainActivity.class));

...
import com.first.menu.Credentials.ARM_CALORIEBURNED;
...
public class activity_floorTriceps_dips extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer, mediaPlayer2, floorTricepsDone;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_floorTriceps_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floortricep_dips);
        ...
        adapter = new activity_floorTriceps_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.arm_floortricepdips);
        mediaPlayer2.start();
        /*Link for tutorial
        btnTutorial = findViewById(R.id.floorTricepsDips_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=geNkbcZ6qDo");
            }
        });

         */

        timer = findViewById(R.id.timer_floortricepdips);
        btnDone = findViewById(R.id.floortricepdips_btndone);
        NextExercise = findViewById(R.id.lastexercise_floortricepdips);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                floorTricepsDone = MediaPlayer.create(activity_floorTriceps_dips.this, R.raw.arm_done_floortricepdips);
                floorTricepsDone.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Workout Complete");
                StyleableToast.makeText(activity_floorTriceps_dips.this, "Workout Complete: CONGRATULATIONS!", R.style.Succeeded).show();
                ...
                bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            if (currentRecord != null) {
                                ...
                                reference.child(Uid).child("Calorie Burn/Arm/Floor Triceps Dip").setValue(formattedCalorieBurn);
                            } else {
                                // BMI record is null
                                Toast.makeText(activity_floorTriceps_dips.this,"No record found!",Toast.LENGTH_SHORT).show();
                            }
                        } else {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(activity_floorTriceps_dips.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                    }
                });
                ...
                countDownTimer = new CountDownTimer(15000, 1000) {
                    ...
                    public void onFinish() {
                        mediaPlayer = MediaPlayer.create(activity_floorTriceps_dips.this,R.raw.whistle);
                        mediaPlayer.start();
                        startActivity(new Intent(activity_floorTriceps_dips.this, ARM_CALORIEBURNED.class));
                        btnDone.setVisibility(View.GONE);
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_floorTriceps_dips.this, MainActivity.class));
                    ...
                    if (floorTricepsDone != null) {
                        floorTricepsDone.stop();
                        floorTricepsDone.release();
                        floorTricepsDone = null;
                    }
                }
            });
        } else {

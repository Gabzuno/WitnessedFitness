...
public class activity_pushUp_arm extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer, mediaPlayer2, PushUpsDone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pushup_arm);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.pushUpArm_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=JyCG_5l3XLk");
            }
        });

         */

        mediaPlayer2 = MediaPlayer.create(this, R.raw.arm_pushups);
        mediaPlayer2.start();

        timer = findViewById(R.id.timer_pushuparm);
        btnDone = findViewById(R.id.pushuparm_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_tricepdips);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PushUpsDone = MediaPlayer.create(getApplicationContext(), R.raw.arm_done_pushups);
                PushUpsDone.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Triceps Dip");
                StyleableToast.makeText(activity_pushUp_arm.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_pushUp_arm.this, activity_tricep_dips.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Arm/Push Ups").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_pushUp_arm.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_pushUp_arm.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_pushUp_arm.this, MainActivity.class));

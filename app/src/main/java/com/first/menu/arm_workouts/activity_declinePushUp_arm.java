...
public class activity_declinePushUp_arm extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer, mediaPlayer2, declinePushUpsDone;

    CountDownTimer countDownTimer;

    ViewPager viewPager;

    activity_declinePushUP_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declinepushup_arm);
        ...
        adapter = new activity_declinePushUP_slideAdapter(this);
        ...
        //Audio
        mediaPlayer2 = MediaPlayer.create(this, R.raw.arm_decline);
        mediaPlayer2.start();

        /*Link for tutorial
        btnTutorial = findViewById(R.id.declinePushUpArm_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=aq2xZxfrQlM");
            }
        });

         */

        timer = findViewById(R.id.timer_declinepushuparm);
        btnDone = findViewById(R.id.declinepushuparm_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_floortricepdips);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                declinePushUpsDone = MediaPlayer.create(activity_declinePushUp_arm.this, R.raw.arm_done_declinepushups);
                declinePushUpsDone.start();

                btnDone.setVisibility(View.GONE);
                NextExercise.setText("Next Exercise: Floor Triceps Dip");
                StyleableToast.makeText(activity_declinePushUp_arm.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (declinePushUpsDone != null) {
                            declinePushUpsDone.stop();
                            declinePushUpsDone.release();
                            declinePushUpsDone = null;
                        }


                        startActivity(new Intent(activity_declinePushUp_arm.this, activity_floorTriceps_dips.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Arm/Decline Push Ups").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_declinePushUp_arm.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_declinePushUp_arm.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_declinePushUp_arm.this, MainActivity.class));

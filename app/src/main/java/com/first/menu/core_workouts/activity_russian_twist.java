...
public class activity_russian_twist extends AppCompatActivity {
    ...
    activity_russian_twist_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new activity_russian_twist_slideAdapter(this);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.russiantwist_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=wkD8rjkodUI");
            }
        });

         */

        timer = findViewById(R.id.timer_russiantwist);
        btnDone = findViewById(R.id.russiantwist_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_leftsidehipdips);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NextExercise.setText("Next Exercise: Left-Side Plank with Hip Dips");
                StyleableToast.makeText(activity_russian_twist.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_russian_twist.this, activity_leftSide_hipDips.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Core/Russian Twist").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_russian_twist.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_russian_twist.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        double metValue = 3.5;
                                        // Calculate calorie burn per minute
                                        double calorieBurn = (metValue * weight * duration * 20) / 20;
                                        // Format calorie burn to 2 decimal places
                                        @SuppressLint("DefaultLocale") String formattedCalorieBurn = String.format("%.2f", calorieBurn);
                                        // Store the calorie burn in the database
                                        reference.child(Uid).child("Calorie Burn/Core/Russian Twist").setValue(formattedCalorieBurn);
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_russian_twist.this, MainActivity.class));

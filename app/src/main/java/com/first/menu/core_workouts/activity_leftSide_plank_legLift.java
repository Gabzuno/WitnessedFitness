...
public class activity_leftSide_plank_legLift extends AppCompatActivity {
    ...
    activity_leftside_plank_leglift_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leftside_plank_leglift);
        ...
        adapter = new activity_leftside_plank_leglift_slideAdapter(this);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.leftsideplanklift_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=4Nqt4bCqSMw");
            }
        });

         */

        timer = findViewById(R.id.timer_leftsideplanklift);
        btnDone = findViewById(R.id.leftsideplanklift_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_rightsideplanklift);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NextExercise.setText("Next Exercise:  Right-Side Plank with Leg Lift");
                StyleableToast.makeText(activity_leftSide_plank_legLift.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_leftSide_plank_legLift.this, activity_rightSide_plank_legLift.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Core/Left Side Plank Leg Lift").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_leftSide_plank_legLift.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_leftSide_plank_legLift.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_leftSide_plank_legLift.this, MainActivity.class));

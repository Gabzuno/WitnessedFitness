...
public class activity_rightSide_plank_legLift extends AppCompatActivity {
    ...
    activity_rightside_plank_leglift_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rightside_plank_leglift);
        ...
        adapter = new activity_rightside_plank_leglift_slideAdapter(this);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.rightsideplanklift_link);
        ...
        timer = findViewById(R.id.timer_rightsideplanklift);
        btnDone = findViewById(R.id.rightSide_plankLift_btnDone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_crunch);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NextExercise.setText("Next Exercise: Abs Crunches");
                StyleableToast.makeText(activity_rightSide_plank_legLift.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_rightSide_plank_legLift.this, activity_abs_crunches.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Core/Right Side Plank Leg Lift").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_rightSide_plank_legLift.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_rightSide_plank_legLift.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_rightSide_plank_legLift.this, MainActivity.class));

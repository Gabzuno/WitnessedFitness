...
public class activity_pushback_pushUp extends AppCompatActivity {
    ...
    activity_pushback_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pushback_pushup);
        ...
        adapter = new activity_pushback_slideAdapter(this);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.pushback_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://youtu.be/Tej3drhzJAg");
            }
        });

         */

        timer = findViewById(R.id.timer_pushback);
        btnDone = findViewById(R.id.pushback_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_planktodowndog);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NextExercise.setText("Next Exercise: Plank to Down Dog");
                StyleableToast.makeText(activity_pushback_pushUp.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_pushback_pushUp.this, activity_plank_downDog.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        double calorieBurn = (metValue * weight * duration * 15) / 15;
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Back and Shoulder/Push Back Push Ups").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_pushback_pushUp.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_pushback_pushUp.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_pushback_pushUp.this, MainActivity.class));

...
public class activity_pushUps_bs extends AppCompatActivity {
    ...
    activity_pushUps_bs_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pushups_bs);
        ...
        adapter = new activity_pushUps_bs_slideAdapter(this);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.pushUpsBs_link);
        ...
        timer = findViewById(R.id.timer_pushupsbs);
        btnDone = findViewById(R.id.pushupsbs_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_inclinepushupbs);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NextExercise.setText("Next Exercise: Incline Push-Ups");
                StyleableToast.makeText(activity_pushUps_bs.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_pushUps_bs.this, activity_incline_bs.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Back and Shoulder/Push Ups").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_pushUps_bs.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_pushUps_bs.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_pushUps_bs.this, MainActivity.class));

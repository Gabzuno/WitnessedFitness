...
public class activity_lateral_lunge extends AppCompatActivity {
    ...
    activity_lateral_lunge_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lateral_lunge);
        ...
        adapter = new activity_lateral_lunge_slideAdapter(this);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.lateral lunge_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=gwWv7aPcD88");
            }
        });

         */

        timer = findViewById(R.id.timer_laterallunge);
        btnDone = findViewById(R.id.laterallunge_btndone);
        btnSkip =findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_pausesquat);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NextExercise.setText("Next Exercise: Pause Squat");
                StyleableToast.makeText(activity_lateral_lunge.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_lateral_lunge.this, activity_pause_squat.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Leg/Lateral Lunge").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_lateral_lunge.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_lateral_lunge.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_lateral_lunge.this, MainActivity.class));

...
public class activity_pause_squat extends AppCompatActivity {
    ...
    activity_pause_squat_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pause_squat);
        ...
        adapter = new activity_pause_squat_slideAdapter(this);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.pause squat_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=0ELH2NcFLZA");
            }
        });

         */

        timer = findViewById(R.id.timer_pausesquat);
        btnDone = findViewById(R.id.pausesquat_btndone);
        NextExercise = findViewById(R.id.lastexercise_pausesquat);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StyleableToast.makeText(activity_pause_squat.this, "Workout Complete: CONGRATULATIONS!", R.style.Succeeded).show();
                ...
                bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            if (currentRecord != null) {
                                ...
                                reference.child(Uid).child("Calorie Burn/Leg/Pause Squat").setValue(formattedCalorieBurn);
                            } else {
                                // BMI record is null
                                Toast.makeText(activity_pause_squat.this,"No record found!",Toast.LENGTH_SHORT).show();
                            }
                        } else {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(activity_pause_squat.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                    }
                });
                ...
                countDownTimer = new CountDownTimer(15000, 1000) {
                    ...
                    public void onFinish() {
                        mediaPlayer.start();
                        startActivity(new Intent(activity_pause_squat.this, legg.class));
                        btnDone.setVisibility(View.GONE);
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_pause_squat.this, MainActivity.class));

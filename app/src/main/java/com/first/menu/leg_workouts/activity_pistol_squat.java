...
public class activity_pistol_squat extends AppCompatActivity {
    ...
    activity_pistol_slideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pistol_squat);
        ...
        adapter = new activity_pistol_slideAdapter(this);
        ...
        /*Link for tutorial
        btnTutorial = findViewById(R.id.pistol squat_link);
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gotoUrl("https://www.youtube.com/watch?v=vq5-vdgJc0I");
            }
        });

         */

        timer = findViewById(R.id.timer_pistolsquat);
        btnDone = findViewById(R.id.pistolsquat_btndone);
        btnSkip = findViewById(R.id.skipRest);
        NextExercise = findViewById(R.id.nextexercise_curtsylunge);
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NextExercise.setText("Next Exercise: Curtsy Lunge");
                StyleableToast.makeText(activity_pistol_squat.this, "Workout Done.", R.style.styleToast).show();
                ...
                btnSkip.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(activity_pistol_squat.this, activity_curtsy_lunge.class));
                        ...
                        bmiRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    if (currentRecord != null) {
                                        ...
                                        reference.child(Uid).child("Calorie Burn/Leg/Pistol Squat").setValue(formattedCalorieBurn);
                                    } else {
                                        // BMI record is null
                                        Toast.makeText(activity_pistol_squat.this,"No record found!",Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                ...
                                Toast.makeText(activity_pistol_squat.this,"Something went wrong!", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                });
        ...
        if(status) {
            customAlertExercise = new CustomAlertExercise(this, new CustomAlertExercise.CustomAlertExerciseListener() {
                ...
                public void onYesClicked() {
                    startActivity(new Intent(activity_pistol_squat.this, MainActivity.class));
